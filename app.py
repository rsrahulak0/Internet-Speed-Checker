...
#
# Main = PhotoImage(file="")
# Label(root, image=Top, bg="#a212d").pack(pady=(40, 0))
#
button = PhotoImage(file="resources/start.png")
Button=Button(root, image=button, bg="#1a212d", bd=0, activebackground="#ae212d", cursor="hand2", command=Check)
Button.pack(pady=10, side=BOTTOM)

#Label
Label(root, text="PING", font="arial 10 bold", bg="#384056").place(x=50, y=0)
Label(root, text="UPLOAD", font="arial 10 bold", bg="#384056").place(x=140, y=0)
Label(root, text="DOWNLOAD", font="arial 10 bold", bg="#384056").place(x=260, y=0)
